...
namespace Magic
{
    public class CallSiteCache09
    {
        struct Signature
        {
            ...
            public Signature(object arg0,object arg1,object arg2,object arg3,object arg4,object arg5,object arg6,object arg7,object arg8)
            {
        ...
        struct Entry
        {
            ...
            public CallsiteFunc<object, object, object, object, object, object, object, object, object, object> Function;
        }
        int cacheSize;
        int count = 0;
        ...
        public CallSiteCache09(int cacheSize)
        {
            this.cacheSize = cacheSize;
            l0l1Cache = new Entry[cacheSize];
        }

        public CallSiteCache09()
        {
            this.cacheSize = 9;
            l0l1Cache = new Entry[cacheSize];
        }

        public void CacheMethod(object arg0, object arg1, object arg2, object arg3, object arg4, object arg5, object arg6, object arg7, object arg8, CallsiteFunc<object, object, object, object, object, object, object, object, object, object> func)
        {
            var c = count < cacheSize ? count++ : count - 1;
            l0l1Cache[c] = new Entry { Signature = new Signature(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8), Function = func };
            // CacheSwap(0, c);
        ...
        {
            return TryGetInner(l0l1Cache, arg0 == null ? typeof(object) : arg0.GetType(),arg1 == null ? typeof(object) : arg1.GetType(),arg2 == null ? typeof(object) : arg2.GetType(),arg3 == null ? typeof(object) : arg3.GetType(),arg4 == null ? typeof(object) : arg4.GetType(),arg5 == null ? typeof(object) : arg5.GetType(),arg6 == null ? typeof(object) : arg6.GetType(),arg7 == null ? typeof(object) : arg7.GetType(),arg8 == null ? typeof(object) : arg8.GetType(),out result);
        }
