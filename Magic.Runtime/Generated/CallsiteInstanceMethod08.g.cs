...
namespace Magic
{
    public class CallsiteInstanceMethod08
    {
        ...
        public object Invoke(object target, object arg0, object arg1, object arg2, object arg3, object arg4, object arg5, object arg6, object arg7)
        {
            ...
            var method = (MethodInfo)Dispatch.BindToMethod(BindingFlags.Public | BindingFlags.Instance, target.GetType(), MemberName, new [] { arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7 });
            if (method != null)
            {
                cache.CacheMethod(target, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, DelegateHelpers.GetMethodDelegate09(method));
                return Dispatch.InvokeUnwrappingExceptions(method, target, new[] { arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7 });
            }
