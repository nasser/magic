...
namespace Magic
{
    public class CallSiteCache07
    {
        struct Signature
        {
            ...
            {
                return object.ReferenceEquals(type0, arg0) && object.ReferenceEquals(type1, arg1) && object.ReferenceEquals(type2, arg2) && object.ReferenceEquals(type3, arg3) && object.ReferenceEquals(type4, arg4) && object.ReferenceEquals(type5, arg5) && object.ReferenceEquals(type6, arg6);
            }
        }
        ...
        bool TryGetInner(Entry[] l0l1Cache, Type arg0, Type arg1, Type arg2, Type arg3, Type arg4, Type arg5, Type arg6, out CallsiteFunc<object, object, object, object, object, object, object, object> result)
        {
            for (var i = 0; i < l0l1Cache.Length; i++)
            {
                ...
                if (entry.Signature.Match(arg0,arg1,arg2,arg3,arg4,arg5,arg6))
                {
