...
namespace Magic
{
    public class CallSiteCache19
    {
        struct Signature
        {
            ...
            public bool Match(Type arg0,Type arg1,Type arg2,Type arg3,Type arg4,Type arg5,Type arg6,Type arg7,Type arg8,Type arg9,Type arg10,Type arg11,Type arg12,Type arg13,Type arg14,Type arg15,Type arg16,Type arg17,Type arg18)
            {
                return object.ReferenceEquals(type0, arg0) && object.ReferenceEquals(type1, arg1) && object.ReferenceEquals(type2, arg2) && object.ReferenceEquals(type3, arg3) && object.ReferenceEquals(type4, arg4) && object.ReferenceEquals(type5, arg5) && object.ReferenceEquals(type6, arg6) && object.ReferenceEquals(type7, arg7) && object.ReferenceEquals(type8, arg8) && object.ReferenceEquals(type9, arg9) && object.ReferenceEquals(type10, arg10) && object.ReferenceEquals(type11, arg11) && object.ReferenceEquals(type12, arg12) && object.ReferenceEquals(type13, arg13) && object.ReferenceEquals(type14, arg14) && object.ReferenceEquals(type15, arg15) && object.ReferenceEquals(type16, arg16) && object.ReferenceEquals(type17, arg17) && object.ReferenceEquals(type18, arg18);
            }
        }
        ...
        {
            return TryGetInner(l0l1Cache, arg0.GetType(),arg1.GetType(),arg2.GetType(),arg3.GetType(),arg4.GetType(),arg5.GetType(),arg6.GetType(),arg7.GetType(),arg8.GetType(),arg9.GetType(),arg10.GetType(),arg11.GetType(),arg12.GetType(),arg13.GetType(),arg14.GetType(),arg15.GetType(),arg16.GetType(),arg17.GetType(),arg18.GetType(),out result);
        }

        bool TryGetInner(Entry[] l0l1Cache, Type arg0, Type arg1, Type arg2, Type arg3, Type arg4, Type arg5, Type arg6, Type arg7, Type arg8, Type arg9, Type arg10, Type arg11, Type arg12, Type arg13, Type arg14, Type arg15, Type arg16, Type arg17, Type arg18, out CallsiteFunc<object, object, object, object, object, object, object, object, object, object, object, object, object, object, object, object, object, object, object, object> result)
        {
            for (var i = 0; i < l0l1Cache.Length; i++)
            {
                if (i >= count) break;
                var entry = l0l1Cache[i];
                if (entry.Signature.Match(arg0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18))
                {
