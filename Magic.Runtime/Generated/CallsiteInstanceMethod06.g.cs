...
namespace Magic
{
    public class CallsiteInstanceMethod06
    {
        ...
        public object Invoke(object target, object arg0, object arg1, object arg2, object arg3, object arg4, object arg5)
        {
            ...
            var method = (MethodInfo)Dispatch.BindToMethod(BindingFlags.Public | BindingFlags.Instance, target.GetType(), MemberName, new [] { arg0,arg1,arg2,arg3,arg4,arg5 });
            if (method != null)
            {
                cache.CacheMethod(target, arg0, arg1, arg2, arg3, arg4, arg5, DelegateHelpers.GetMethodDelegate07(method));
                return Dispatch.InvokeUnwrappingExceptions(method, target, new[] { arg0,arg1,arg2,arg3,arg4,arg5 });
            }
