...
namespace Magic
{
    public static partial class DelegateHelpers
    {
        public static CallsiteFunc<object, object, object, object, object, object, object, object> GetMethodDelegate07(MethodInfo method)
        {
            ...
            if(method.IsStatic)
                ret = (arg0,arg1,arg2,arg3,arg4,arg5,arg6) => method.Invoke(null, new[] { arg0,arg1,arg2,arg3,arg4,arg5,arg6 });
            else
                ret = (target, arg1, arg2, arg3, arg4, arg5, arg6) => method.Invoke(target, new [] { arg1,arg2,arg3,arg4,arg5,arg6 });
            return ret;
        }
